                                ...
                                <div class="booking-list">
                                    ...
                                    <div class="booking-action">
                                        ...
                                        <?php  
                                            ...
                                            if ($bookings['status'] != 11 && $bookings['status'] != 10 && $bookings['status'] != 9 && $bookings['cod'] == 1 && $bookings['status'] == 8 && $refund_staus['status'] == 0) {
                                        ?>
                                        ...
                                        <?php } elseif($bookings['status'] != 11 && $bookings['status'] != 10 && $bookings['status'] != 9 && $refund_staus['status'] == 0 && $bookings['cod'] == 2) { ?>
